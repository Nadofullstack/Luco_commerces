<template>
  <div
    class="bg-forest dark:bg-forest/20 rounded-2xl p-6 border border-sage/30 relative overflow-hidden"
  >
    <div class="relative z-10">
      <h4 class="text-white font-bold text-lg mb-2">Inventory Insights</h4>
